  ...
  return (
    <>
      ...
      <div className={isOpen ? 'overflow-hidden' : ''}>
        ...
        <div 
          className={`fixed inset-x-0 top-0 h-[100vh] bg-gradient-to-b from-card/95 to-card/90 backdrop-blur-xl shadow-xl z-[95] md:hidden transform transition-transform duration-300 ease-in-out ${
        ...
        >
          ...
          <div className="pt-[60px] container mx-auto px-4 sm:px-8 py-6 sm:py-8 flex flex-col h-full">
              ...
              <ul className="space-y-4 sm:space-y-6">
                {navItems.map((item, index) => (
                  <li key={index} className="transform transition-all duration-200" style={{ 
                    ...
                    <button
                      className="relative text-white text-base sm:text-xl font-bold tracking-wide hover:text-purple-400 transition-all duration-300 py-2 w-full text-left group flex items-center overflow-hidden"
                    ...
                    >
                      ...
                      <span className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:translate-x-1">&rarr;</span>
                    </button>
                  </li>
                ))}
              </ul>
            ...
            <div className="mt-auto pt-4 sm:pt-6 border-t border-white/10">
              <button
                className="w-full bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-white rounded-lg py-3 sm:py-4 text-sm sm:text-base font-bold tracking-wide transition-all duration-300 shadow-lg hover:shadow-purple-500/20 relative overflow-hidden group"
                onClick={() => handleNavigation('#contact')}
              >
                <span className="relative z-10">Contact Us</span>
                <span className="absolute inset-0 bg-gradient-to-r from-purple-800 to-purple-950 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
              </button>
            </div>
          </div>
        </div>
